...
module retrocore_sdram_controller #(
 ...
 parameter TRP=2, parameter TRCD=2, parameter TRFC=7,
...
localparam ST_POWER=0,ST_PRE=1,ST_TRP=2,ST_REF1=3,ST_RFC1=4,ST_REF2=5,ST_RFC2=6,
 ...
 ST_PRECHARGE=14,ST_WAITRP=15,ST_REFRESH=16,ST_WAITRFC=17;
...
always @(posedge clk) begin
 ...
 ST_MRS: begin sdram_ras_n<=0;sdram_cas_n<=0;sdram_we_n<=0;sdram_a<=13'b0000000100000;refresh<=0;state<=ST_IDLE;end
 ST_IDLE: begin
