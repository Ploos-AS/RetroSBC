...
assert s.count('(at -4.896 ') == 20, "left-side pad geometry drifted"
assert s.count('(at 4.896 ') == 20, "right-side pad geometry drifted"
assert s.count(' 90)') == 20, "bottom-side rotation/count drifted"
assert s.count(' 270)') == 20, "top-side rotation/count drifted"
